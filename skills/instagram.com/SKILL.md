...
Verified 2026-06-23 against `@example_account` with the grid paged to exhaustion: `/reel/DV_zF4qglmJ/` (17 Mar) → archived=true (permalink renders, absent from grid); five live controls (`/reel/DWGrGuNgh1n/`, `/reel/DWQ1ADCgnmR/`, and three June reels) → archived=false (all present in grid).
