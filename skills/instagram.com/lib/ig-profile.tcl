# The instagram.com profile read: navigate as a viewer does, dump the rendered
# outerHTML, and parse what the page shows. It never touches the private
# api/v1/web_profile_info endpoint, which earned an HTTP 429.
#
# It builds the canonical envelope {result, cursor, hasMore, fault}, where
# `result` is a superset a caller projects from, taking whichever fields it
# wants. A removed or non-existent profile emits a fault of shape "removed"; a
# login wall emits shape "login_wall".
#
# Only the policed verbs nav/dump/dwell/log/emit are used. The HTML helpers come
# from ig-html.tcl beside it.
