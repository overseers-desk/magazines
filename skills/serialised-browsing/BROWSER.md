...
**API / non-browser skills** are not affected by D1-D5 because they do not touch a browser. Examples: serpapi, renfe.com, claude-api, send-email, courier. Credentials live in environment variables or `~/.claude/skills/config.ini`.
