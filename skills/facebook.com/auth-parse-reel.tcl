...
#
# Serialiser path (see SKILL.md §6): browser-serialiser facebook.com/auth-parse-reel <post-permalink-url>
#   navigates to the permalink, dumps the rendered DOM, and runs the identical parse.
# Direct path (legacy, file-fed): tclsh auth-parse-reel.tcl <html-file>
#
...
#     browser-serialiser facebook.com/auth-parse-reel <post-permalink-url>
# ---------------------------------------------------------------------------
...
if {[info exists argv0] && [file tail [info script]] eq [file tail $argv0]} {
    if {[llength $argv] < 1} {
        puts "Usage: auth-parse-reel.tcl <reel-permalink.html>"
        exit 1
    }
