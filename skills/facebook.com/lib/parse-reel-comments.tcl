# The facebook.com reel-comment parser and its Markdown renderer. Both the
# viewer-driven action and the file-fed one run this same parse, so the two
# produce byte-identical output for the same capture.
