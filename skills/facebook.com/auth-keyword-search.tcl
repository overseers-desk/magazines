...
#
# Serialiser path (see SKILL.md §8): browser-serialiser facebook.com/auth-keyword-search <handle|profile-url> keyword1 keyword2 ...
#   navigates to the profile, dumps the rendered DOM, and runs the identical search.
# Direct path (legacy, file-fed): tclsh auth-keyword-search.tcl <html-file> keyword1 keyword2 ...
#
...
#     browser-serialiser facebook.com/auth-keyword-search <handle|profile-url> keyword1 [keyword2 ...]
# ---------------------------------------------------------------------------
...
if {[info exists argv0] && [file tail [info script]] eq [file tail $argv0]} {
    if {[llength $argv] < 2} {
        puts "Usage: auth-keyword-search.tcl <profile.html> keyword1 \[keyword2 ...\]"
        exit 1
    }
