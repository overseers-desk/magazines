...
#   browser-serialiser linkedin.com/auth-parse-search '{"keywords":"loan","connectionOf":["ACoAA..."]}'
#
# Direct path (offline parser test against a saved page):
#   tclsh9.0 auth-parse-search.tcl <search-results.html>
#
...
if {[info exists argv0] && [file tail [info script]] eq [file tail $argv0]} {
    if {[llength $argv] != 1} {
        puts stderr "Usage: auth-parse-search.tcl <search-results.html>"
        exit 1
    }
