...
#     browser-serialiser linkedin.com/auth-set-profile-field headline "New headline" [--dry-run]
#     browser-serialiser linkedin.com/auth-set-profile-field about   "New about"    [--dry-run]
#     browser-serialiser linkedin.com/auth-set-profile-field <field> --dump          # recon: open the form, report current value
#     browser-serialiser linkedin.com/auth-set-profile-field <field> --self-test      # prove Save round-trips, leaving no visible change
#
...
#
# Mirrors auth-send-invite.tcl's serialiser_run: nav -> tag-via-eval -> click/type ->
...
# Code-point length (surrogate-pair aware), lifted from auth-send-invite.tcl.
proc cp_length {s} {
